...
Using the SCM, we derive a statistical model to address violations of the equal dispersion assumption in CJ experiments:

::: {#fig-cj16 layout-ncol=2}
...
Comparative judgment model, SCM and statistical model assuming different discriminal dispersions for the student's traits
:::
...
:::
$$
\sum_{g=1}^{G} \color{blue}{s_{XI}}[g]/G = 1; \quad \sum_{g=1}^{G} \color{blue}{s_{ZJ}}[g]/G = 1
$$
:::
