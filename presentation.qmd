...
::: incremental
1. **Context:** Writing exercise
2. **Research question:** "To what extent do different teaching methods influence students' ability to produce high-quality written texts?" 
3. **Method:** Randomization and a CJ experiment, specifically:

::: incremental
::: {style="font-size:80%;"}
- Assign students to **two** different teaching method $X=\{1,2\}$
...
4. **Estimand:** "*On average*, is there a difference in the ability to produce high-quality written texts between the two groups of students?"

5. **Estimator:** the Bradley-Terry-Luce (BTL) model [@Bradley_et_al_1952; @Luce_1959]

6. **Estimates:** BTL scores, or their transformations
...
## 3. Issues with this practice {style="font-size:80%;"}

What are the **issues** with this practice?:

::: incremental
::: {style="font-size:80%;"}
1. Excessive reliance on Case V's assumptions for the analysis of CJ data, specifically on,
...
::: {.notes}
But, what the literature has done so far, is it sufficient?
:::
...
The BTL model is the **measurement model** for CJ [@Laming_2004; @Pollitt_2012b; @Whitehouse_2012; @vanDaal_et_al_2016; @Lesterhuis_2018_thesis; @Coertjens_et_al_2017; @Goossens_et_al_2018; @Bouwer_et_al_2023]
...
::: {.fragment}
But, this ignores the **uncertainty** of the BTL scores
:::
...
2. Strengthening measurement reliability and validity [@Perron_et_al_2015, pp. 2]
3. Enhance the statistical accuracy of the hypotheses test
:::
:::
...
\begin{aligned}
  ...
  e_{I} & \sim \text{Normal}(0, \color{blue}{s^{g}_{I}} ) \color{blue}{\longleftarrow} \\
  e_{JK} & \sim \text{Normal}(0, p_{JK}) \\
  e_{J} & \sim \text{Normal}(0, \color{blue}{s^{g}_{J}} ) \color{blue}{\longleftarrow} \\
  \\
  & \text{contraints:} \\
  & \sum_{g=1}^{G_{I}} \color{blue}{s^{g}_{I}}/G_{I} = 1 ; \quad \sum_{g=1}^{G_{J}} \color{blue}{s^{g}_{J}}/G_{J} = 1
\end{aligned}
$$
:::
