...
With the structure in the previous SCM, we can derive a statistical model that addresses violations of the equal dispersion assumption in CJ experiments. 

::: incremental
::: {style="font-size:80%;"}
a. This is possible because SCMs encodes functional and probabilistic information, which we can replace with appropriate functions and probabilistic assumptions [@Pearl_et_al_2016]. 
b. SCMs allows us to express the joint distribution of our complex CJ system as a product of simpler conditional probability distributions (CPDs)
:::
:::
...
\begin{aligned}
  ...
  e_{J} & \overset{iid}{\sim} \text{Normal}(0,\color{blue}{s_{XI}} ) \color{blue}{\longleftarrow} \\
