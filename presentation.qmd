...
## 3. Some issues with this practice {style="font-size:80%;"}
...
1. Excessive reliance on Case V's assumptions for the analysis of CJ data
    ...
    $\longrightarrow$ the assumption of **equal dispersion** between stimuli
    
    $\longrightarrow$ the assumption of **zero correlation** between stimuli
...
3. Researcher need knowledge of **Probabilistic Programming Languages (PPL)**
...
2. Apply the model to, for instance, replication studies:
...
e. Do repeated judgments bring benefits?
f. Are additive better than multiplicative judges' biases (akin to discrimination parameter in IRT)
g. How to work with random and non-random samples
h. **etc. etc. etc.**
:::
:::
