...
::: {.fragment}
e.g., if the experiment has five texts to compare. Thus, under the **General form**:
...
::: {.fragment}
But, this ignores the uncertainty of BTL **point estimates**
:::
...
Thus, to address these issues in a more systematic and integrated way, we use the **_structural approach_** to causal inference [@Pearl_2009; @Pearl_et_al_2016; @Gross_et_al_2018; @Neal_2020]
...
::: incremental
::: {style="font-size:80%;"}
a. The sample mechanism is a **generator** of *missing data* (MCAR, MAR, MNAR) 
b. The comparison mechanism is a **generator** of *missing data* (MCAR, MAR, MNAR)
:::
:::
